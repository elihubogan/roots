...
<?php $billing_last_name = get_post_meta($wpo_wcpdf->export->order->id,'_billing_last_name',true); ?>
<?php echo $billing_last_name; echo " - "; ?>
<?php $order_number = $wpo_wcpdf->order_number(); ?>
